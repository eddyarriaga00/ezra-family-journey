...
const copy = {
  en: {
    ...
    momentsTitle: 'Ezra’s moments', momentsCopy: 'The little things we never want to forget.', gripTitle: 'A stronger grip every day', gripCopy: 'He held on just a little tighter today.', firstBottle: 'First bottle', add: 'Add',
  ...
  es: {
    ...
    momentsTitle: 'Los momentos de Ezra', momentsCopy: 'Las pequeñas cosas que nunca queremos olvidar.', gripTitle: 'Un agarre más fuerte cada día', gripCopy: 'Hoy se agarró un poquito más fuerte.', firstBottle: 'Primer biberón', add: 'Agregar',
